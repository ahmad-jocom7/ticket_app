class ApiUrl {
  ...
  // static const String baseUrl = "https://ticketing_api.jocom.jo:83/api";


  static const String login = "Login/LoginApp";

  static const String getAssignedTickets = "Ticket/getAssignedTicketsByEmployee";
  static const String getAcceptedTickets = "Ticket/getAssignedTicketsByEmployee";
  ...
  static const String getSystemConfiguration = "SystemSetting/GetSystemConfigration";
  ...
  static const String getSubProductFileByCustomerRefNo = "SubProductFile/GetSubProductFileByCustomerRefNo";
  ...
  static const String getSubProductFileBySerialNo = "SubProductFile/GetSubProductFileBySerialNo";
